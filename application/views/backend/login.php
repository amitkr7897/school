      ...
      <div class="auth-box-w">
        ...
        <form method="post" role="form" id="form_login">
          <div class="form-group">
            <label for=""><?php echo get_phrase('username');?></label><input class="form-control" name="user" id="user" placeholder="<?php echo get_phrase('username');?>" required type="text">
            <div class="pre-icon icon-user"></div>
          </div>
          <div class="form-group">
            <label for=""><?php echo get_phrase('password');?></label><input class="form-control" name="password" id="password" value="" placeholder="<?php echo get_phrase('password');?>" required type="password">
            <div class="pre-icon icon-lock"></div>
          </div>
          <div class="buttons-w logs row">
            <div class="col-sm-6"><button class="btn btn-rounded btn-primary"><?php echo get_phrase('login');?></button></div>
			<div class="col-sm-6 reg"><a class="btn btn-rounded btn-secondary"  href="<?php echo base_url();?>register/"><?php echo get_phrase('register');?></a></div>			
          </div>
